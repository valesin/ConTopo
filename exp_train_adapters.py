...
def get_adapter_model(input_dim: int, num_classes: int = 10) -> nn.Module:
    """
    Creates a simple MLP adapter: Linear -> ReLU -> Linear
    """
    ...
    for ens in ensemble_utils.iter_ensemble_inference_data_from_config(config_path):
        ...
        metrics = {
            ...
            "adapter_architecture": {
                "embed_only": f"{input_dim_embed} -> 64 -> 10",
                "embed_sim": f"{input_dim_embed_sim} -> 64 -> 10",
            },
        ...
        del y_train, y_test, adapter_embed, adapter_embed_sim
