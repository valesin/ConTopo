...
similarity_profile = profiles['cosine_results'][:, :, image_idx]  # shape: [num_models, num_classes]
...
print("Manual verification skipped — anchors now come from TRAIN set (see exp_similarityprofiles.py).")
# %%
